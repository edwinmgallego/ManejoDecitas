...
public class UIPatientMenu {
    ...
    private static void showBookAppointmentMenu(){
        ...
        do {
            ...
            if (response == 1){
                UIMenu.patinetLogged.addAppointmentDoctors( doctorSelected,doctorSelected.getAvailableAppointments().get(indexDate).getDate(null), doctorSelected.getAvailableAppointments().get(indexDate).getTime());
        ...
        do{
            ...
            for (int i = 0; i < UIMenu.patinetLogged.getAppointmentDoctors().size(); i++) {
                  ...
                  System.out.println(j +" . "+
                          "Date:  "+UIMenu.patinetLogged.getAppointmentDoctors().getDate() +
                          "Time:  "+ UIMenu.patinetLogged.getAppointmentDoctors().getTime()+
                          " \n Doctor: "+ UIMenu.patinetLogged.getAppointmentDoctors().getDoctor().getName()
                );
